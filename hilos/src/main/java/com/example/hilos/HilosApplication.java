...
public class HilosApplication implements Runnable {

    String[] urlsList;

    public HilosApplication(String[] urlsList) {
    ...
    public static void main(String args[])
    {
        ...
        Thread downloaderOne = new Thread(new HilosApplication(Arrays.copyOfRange(urls1, 0, urls1.length)));
        Thread downloaderTwo = new Thread(new HilosApplication(Arrays.copyOfRange(urls2, 0, urls2.length)));
